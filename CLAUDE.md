...
학원 강사(약 40명 학생 담당)를 위한 학생 관리 웹 애플리케이션. 학원은 기존에 엑셀로 학생 정보를 관리하고 있어, 이 시스템은 엑셀 워크플로우를 대체하지 않고 병행하면서 성적 분석·숙제 관리 등을 보완하는 것을 목표로 한다. 자세한 배경과 기능 목록은 README.md, 단계별 계획은 ROADMAP.md 참고.
